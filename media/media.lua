...
m.fonts = {
	asap = [[Interface\AddOns\oUF_Nine\media\fonts\asap_condensed-regular.ttf]],
	myriad = [[Interface\AddOns\oUF_Nine\media\fonts\myriad_condensed.ttf]],
	frizq = [[Fonts\FRIZQT___CYR.TTF]],
	arial = [[Fonts\ARIALN.TTF]],
}

m.textures = {
	absorb_texture = [[Interface\RaidFrame\Shield-Fill]],
	absorb_overlay = [[Interface\RaidFrame\Shield-Overlay]],
